...
namespace MarketAnalyticHub.Migrations
{
    ...
    [Migration("20240716153930_ApplicationDbContextPortfolioCompanies")]
    partial class ApplicationDbContextPortfolioCompanies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketAnalyticHub.Models.SetupDb.Dividend", b =>
                {
                    b.HasOne("AspnetCoreMvcFull.Models.Portfolio.Portfolio", "Portfolio")
                        .WithMany()
                        .HasForeignKey("PortfolioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
